...
typedef struct inode {
        ...
        uint32_t direct_pointers[7];            // 4 direct pointers, mostly because the kernel needs 4 blocks (will likely change to 5 soon)
        uint8_t single_indirect_block;         // 1 single indirect pointer
        uint8_t max_count;
        uint8_t padding;
